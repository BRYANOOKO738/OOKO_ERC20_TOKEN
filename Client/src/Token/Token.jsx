...
import { Wallet, TrendingUp, Shield, Users, Clock, AlertCircle } from 'lucide-react';
...
export default function TokenSaleDApp() {
  ...
  const connectWallet = async () => {
    ...
    setUserAddress('0x742d35Cc6634C0532925a3b8D2...9f7d161d89');
    // Mock user token balance
    setUserTokenBalance(12500);
  };
  ...
  const purchaseTokens = () => {
    ...
    if (amount < saleData.minPurchase || amount > saleData.maxPurchase) {
      alert(`Purchase amount must be between ${saleData.minPurchase} and ${saleData.maxPurchase} tokens`);
      return;
    }

    // Mock purchase transaction
    alert(`Purchasing ${purchaseAmount} ${saleData.tokenSymbol} tokens for ${ethAmount} ETH`);
    setUserTokenBalance(prev => prev + amount);
    setPurchaseAmount('');
    setEthAmount('');
  };
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-8">
          <div className="flex items-center space-x-3 mb-4 md:mb-0">
            ...
            <h1 className="text-2xl md:text-3xl font-bold">ZepToken Sale</h1>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-6 mb-8">
          <div className="bg-gray-800 p-6 rounded-2xl border border-gray-700">
            ...
            <p className="text-2xl font-bold">{userTokenBalance.toLocaleString()}</p>
